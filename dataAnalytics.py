...
from sklearn.metrics import silhouette_score, accuracy_score, classification_report, confusion_matrix, \
    mean_absolute_error, mean_squared_error, r2_score, mean_absolute_percentage_error, f1_score
...
Missing values are related to things that don't exist (like houses not having a fireplace or 
...
(1) New feature: GarageAreaPerCar
...
# Keep scores for comparison
nb_accuracy = accuracy_score(y_test, y_pred_nb)
nb_weightedF1 = f1_score(y_test, y_pred_nb, average="weighted")
...
svm_weightedF1 = f1_score(y_test, y_pred_svm, average="weighted")

"""
SVM accuracy is dramatically improved (by 27% compared to NB), as are the F1-scores.
"""
...
comparison = pd.DataFrame({
    ...
    "Weighted F1": [nb_weightedF1, svm_weightedF1]
})
...
"""
End of classification. Now building neural networks to predict SalePrice.
"""
...
mape = mean_absolute_percentage_error(y_test, y_pred_log)
rmse = np.sqrt(mean_squared_error(y_test, y_pred_log))
r2 = r2_score(y_test, y_pred_log)

print("FF Neural Network Results:")
print("MAE:", mae)
print("MAPE:", mape)
print("RMSE:", rmse)
print("R²:", r2)

# Plot to visualize model training
plt.figure(figsize=(8,5))
